...
$params = [$ay_code, $semester, $search_room];
$types = 'sss'; // Parameter types
...
function fetchScheduleForRoom($room_sched_code, $ay_code, $semester, $room_id)
{
   ...
   ";
    ...
    $stmt_schedule->bind_param("ss", $semester, $room_code);
...
';
    ...
    foreach ($day_names as $day_name) {
        $html .= '<th style="width: 10%; text-align: center; font-size: 9px; padding: 3px;">' . $day_name . '</th>';
    }
    $html .= '</tr></thead>';
    $html .= '<tbody>';
    $time_slots = [];
    ...
    $html .= '</tr>';
    $html .= '<tr class="noExport">';
    $html .= '<td colspan="3" style="position: absolute; top: -9999px; left: -9999px; border: none; text-align: center; font-size: 10px;">CCL Head</td>';
...
<body>
    ...
    <div class="header">
        <h2 class="title"> <i class="fa-solid fa-bars-progress" style="color:#FD7238;"></i> COMPUTER LABORATORY REPORT
        </h2>
